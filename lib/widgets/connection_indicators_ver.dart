...
class AppbarConnectionIndicators extends StatefulWidget {
  @override
  _AppbarConnectionIndicatorsState createState() => _AppbarConnectionIndicatorsState();
}

class _AppbarConnectionIndicatorsState extends State<AppbarConnectionIndicators> {
  ...
  final Map<String, Stream> _streams = {_BT: _manager.btLitStream, _SFTP: _manager.sftpLitStream};
}
